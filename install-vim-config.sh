...
mkdir bundle
cd autoload
wget https://raw.githubusercontent.com/tpope/vim-pathogen/master/autoload/pathogen.vim --no-check-certificate
cd ..
...
wget https://raw.githubusercontent.com/james-jw/vim/master/vimrc --no-check-certificate
